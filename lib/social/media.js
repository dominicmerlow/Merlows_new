...
function buildDirectHeroPrompt(articleTitle) {
  const topic = (articleTitle || 'clinical research').replace(/^(Clinical Review|Op Ed|IBD Industry News|Industry News|White Paper|Infographic|Living with IBD):?\s*/i, '').slice(0, 120);
